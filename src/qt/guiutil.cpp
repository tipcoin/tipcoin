...
{
    // Convert tipcoin:// to tipcoin:
    //
    //    Cannot handle this later, because tipcoin:// will cause Qt to see the part after // as host,
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (!optionFile.good())
            return false;
        // Write a tipcoin.desktop file to the autostart directory:
